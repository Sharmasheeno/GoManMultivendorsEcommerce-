...
const Footer = () => {
    ...
    const socialIcons = [
        { icon: FacebookIcon, link: "https://www.facebook.com/Sharmasheyne" },
        { icon: InstagramIcon, link: "https://www.instagram.com/sharma_sheeno1/" },
        { icon: TwitterIcon, link: "https://x.com/formula_crazy" },
        { icon: LinkedinIcon, link: "https://www.linkedin.com/in/sharmake-hassan-said-8949542b3/" },
    ]
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="relative text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">GoMan</span>Shop
